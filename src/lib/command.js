...
class Command {
  ...
  Flag(Long, Short, Value, About) {
    ...
    if (Long === null) {
      // Needs a stacktrace of what caused the error.
      console.error("command: error: Long must not be null. Please review your command and flags configuration.")
      process.exit(1)
    }
  ...
  Parse() {
    ...
    this.Flag("help", null, false, "Show this output")
    this.Flag("version", null, false, "Show command version")
